...
public class onClickAttack2 : MonoBehaviour
{
    ...
    public void onClickAttaque2()
    {
        ...
        DialogueToDisp.text = "Charmander attacks with Fire Punch!";
        StartCoroutine(Test());
    }
    ...
    IEnumerator Test()
    {
        ...
        Pkm_attacked.GetComponent<HeroStateMachine>().hero.health_points = Pkm_attacked.GetComponent<HeroStateMachine>().hero.health_points - Pkm_attacker.GetComponent<HeroStateMachine>().hero.damage_attack2;
